...
exports.CONTRONYM_POOL = void 0;
const sources_1 = require("./sources");
exports.CONTRONYM_POOL = [
    ...
    // --- PUZZLE 2: The Authority Paradox ---
    {
        ...
        tension: "Official language invented words that could go either way. Sanction lets you proceed — and sanction stops you cold. Enjoin orders you to act — and enjoin bars you from acting. The same bureaucratic vocabulary that grants authority also revokes it, because power has always needed to be able to say yes and no with the same breath. These are not accidents of usage; they are the structure of institutional double-speak built into the foundation of legal English.",
    ...
    // --- PUZZLE 3: Both Ways (MATCH) ---
    {
        ...
        tension: "A Janus word is not a coincidence — it is a site where the language was pulled in two directions hard enough to leave a scar. Every word here records a moment when the same concept was used for opposite ends, and neither usage won. The word held the tension until the tension became the word.",
...
(0, sources_1.applyDatasetProvenance)(exports.CONTRONYM_POOL, "contronym");
