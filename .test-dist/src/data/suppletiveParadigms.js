...
exports.SUPPLETIVE_EXTENDED_POOL = void 0;
...
exports.SUPPLETIVE_EXTENDED_POOL = [
    // ── ADJECTIVE IDENTITY THEFT ─────────────────────────────────────────────────
    {
        ...
        tension: "Less and least have no genetic connection to little — they come from a separate Old English root meaning 'to be small.' Little is an orphan in its own paradigm.",
    },
    {
        ...
        tension: "Much and many are entirely different words pressed into service as a single paradigm. They share 'more' and 'most' as a common comparative/superlative — two roots borrowing one ladder.",
    },
    {
        ...
        tension: "Next is the superlative of near — the nighest. We've forgotten the family tie so completely that 'next' now means 'following in sequence,' not 'closest in space.'",
    },
    {
        ...
        tension: "Elder and eldest are the authentic Old Germanic comparative forms — 'older' and 'oldest' are modern regularizations that invaded the paradigm. Elder survived only in family and religious contexts.",
    },
    {
        ...
        tension: "Further began its life as a separate adverb meaning 'more forward' — it invaded the 'far' paradigm and won the metaphorical register. We say 'farther along the road' but 'further discussion.'",
    },
    {
        ...
        tension: "Last is just 'latest' worn down to a single syllable — 'lat-est' contracted to 'last.' We've forgotten it's a superlative and now treat 'last' and 'latest' as separate, slightly different words.",
    },
    // ── PRONOUN FRANKENSTEINS ────────────────────────────────────────────────────
    {
        ...
        tension: "She is not related to her — it came from an Old English demonstrative 'seo' (that/the) that moved in to replace the original feminine pronoun 'heo,' which kept being confused with 'he.'",
    },
    {
        root: "I / me / my",
        lang: "Proto-Germanic",
        ...
        tension: "I and me come from entirely different Proto-Indo-European roots. 'I' pointed to 'here (where I am)'; 'me' pointed to 'this self.' Every first-person pronoun in English is a philosophical composite.",
    },
    {
        root: "this / these",
        lang: "Old English",
        ...
        tension: "These was built by adding a plural suffix from a different demonstrative family onto the singular 'this.' And 'those' is similarly alien to 'that.' The demonstrative system is a patchwork of borrowed plurals.",
    },
    {
        root: "who / whom / whose",
        lang: "Old English",
        ...
        tension: "Who/whom/whose are the last surviving ruins of Old English grammatical case — a full case system that once governed every noun and pronoun, now reduced to this single set of fossils.",
    },
    // ── PLURAL GHOSTS ────────────────────────────────────────────────────────────
    {
        root: "person / people",
        ...
        tension: "People is not the plural of person — it's a completely different Latin word (populus, 'the public') pressed into service as a plural because 'persons' felt too formal and 'peoples' took on a different meaning.",
    },
    {
        root: "child / children",
        lang: "Old English",
        ...
        tension: "Children carries two plural markers stacked on top of each other. Old English 'cildru' added '-ru' for plural; then Middle English added '-en' on top of that — apparently one plural wasn't enough.",
    },
    // ── VERB MERGERS & STRONG DISTORTIONS ────────────────────────────────────────
    {
        ...
        tension: "The 'aw' in saw is a relic of an ancient vowel grade that has no connection to the 'ee' in see — they are the same root in two different ancient vowel states, preserved in English like insects in amber.",
    },
    {
        root: "do / did / done",
        lang: "Old English",
        ...
        tension: "Did is one of the last survivors of Indo-European reduplication — an ancient way of marking the past by doubling the root ('de-do'). It is a fossil of a grammatical system that English otherwise abandoned entirely.",
    },
    {
        root: "stand / stood",
        lang: "Old English",
        ...
        tension: "The 'n' in stand is a nasal infix — a sound inserted into the root only in the present tense. The moment you step into the past, it disappears entirely. Stood has no 'n' because the root never needed one.",
    },
    {
        root: "tell / told",
        lang: "Old English",
        ...
        tension: "Tell and told contain the same root — the 'e' in tell was caused by i-mutation (a vowel shift triggered by a now-vanished suffix), while told preserves the original vowel. It's the same root in two different heat-treated states.",
    },
    {
        root: "seek / sought",
        lang: "Old English",
        ...
        tension: "Seek and beseech are the same root — the 'k' and 'ch' sounds split the word into two. Sought is the past tense of both, hidden behind a vowel shift that makes the family resemblance almost invisible.",
    },
    // ── MODAL ARCHAISMS ──────────────────────────────────────────────────────────
    {
        root: "will / would",
        ...
        tension: "Will originally meant 'to desire' or 'to wish' — a fully-felt wanting. Would is its past tense, preserving that ancient desire in the conditional. The 'l' and 'd' are the only things holding this old wish together.",
    },
    {
        root: "can / could",
        lang: "Old English",
        ...
        tension: "The 'l' in could was inserted by analogy with would and should — it was never pronounced and has no etymological basis. But the 'n' in can is genuine: it descends from the verb 'to know,' making 'can' literally mean 'to know how.'",
    },
];
for (const entry of exports.SUPPLETIVE_EXTENDED_POOL) {
    if (!("questionPrompt" in entry)) {
        entry.questionPrompt = `Sort forms in the "${entry.root}" paradigm without assuming regular inflection.`;
    }
    if (!("revealBody" in entry)) {
        entry.revealBody = entry.tension;
    }
}
// Provenance annotations
(0, sources_1.applyDatasetProvenance)(exports.SUPPLETIVE_EXTENDED_POOL, "suppletive_paradigms");
