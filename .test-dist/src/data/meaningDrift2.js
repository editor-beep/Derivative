...
exports.MEANING_DRIFT_POOL_2 = void 0;
...
exports.MEANING_DRIFT_POOL_2 = [
    // ── PEJORATION (continued) ───────────────────────────────────────────────────
    {
        ...
        tension: "Naughty began as poverty — 'naught' meant nothing. The wealthy decided that having nothing was a moral condition, and the word slid from destitution through wickedness to a child's misbehavior.",
    },
    {
        root: "cunning",
        ...
        tension: "Cunning once meant what 'knowledgeable' means now. The verb 'can' shares this root — to know how. The slide from 'knowing' to 'scheming' reveals a cultural suspicion of expertise.",
    },
    {
        root: "artificial",
        ...
        tension: "Artificial once meant 'full of art' — a compliment. The word turned as 'natural' became the standard of value. What humans made became suspect; what they felt artificially became the index of their inauthenticity.",
    },
    {
        root: "vulgar",
        lang: "Latin → Modern English",
        ...
        tension: "Vulgar simply meant 'of the people' — the Vulgate Bible was named for being in the people's language. Elite contempt for the masses rebranded the word for 'common' into the word for 'crude.'",
    },
    {
        root: "boor",
        ...
        tension: "Boor is farmer turned insult — another case of urban culture deciding that working the land was morally and socially inferior. The Boers of South Africa kept the neutral meaning; English kept only the contempt.",
    },
    {
        root: "quean",
        lang: "Old English → Modern English",
        ...
        tension: "Quean began as a neutral word for woman — it was the same root as 'queen' (which took the prestige path). Quean took the contempt path: the same syllable, the same root, split by class into majesty and disgrace.",
    },
    // ── AMELIORATION (continued) ─────────────────────────────────────────────────
    {
        ...
        tension: "Marshal began as a stable hand. The horses were the most powerful military asset, so the person who managed them rose with the technology they controlled — from mucking stalls to commanding armies.",
    },
    {
        root: "minister",
        lang: "Latin → Modern English",
        ...
        tension: "Minister literally means 'the lesser one' — the word for servant became the word for head of government. The Christian rebranding of servitude as honor did the work; politics completed the reversal.",
    },
    {
        root: "brave",
        ...
        tension: "Brave entered English meaning savage. European culture slowly reframed wildness as virtue — the untamed energy of the barbarian became the moral courage of the hero. The word was civilized before the concept was.",
    },
    {
        root: "bold",
        lang: "Old English → Modern English",
        ...
        tension: "Bold began as an insult for overstepping. As individualism rose in value, the reckless presumptuous person became the admirable self-starter. The same behavior, rebranded by a cultural shift.",
    },
    {
        root: "fame",
        lang: "Latin → Modern English",
        ...
        tension: "Fame once meant any report — scandal and glory alike. The word narrowed exclusively to positive public attention, while 'infamy' (in-fame) was left to carry the negative. Fame won the prestige; infamy kept the dirt.",
    },
    {
        root: "fond",
        lang: "Middle English → Modern English",
        ...
        tension: "Fond was once an insult — the 'fonned' person was a fool. The word's journey shows how societies came to value affection over reason: the fool who loves became the person most fully alive.",
    },
    // ── SEMANTIC BLEACHING (continued) ───────────────────────────────────────────
    {
        ...
        tension: "Awesome once described God and natural catastrophe. By the 1980s it described a good sandwich. The entire weight of divine terror drained in under a century of casual use.",
    },
    {
        root: "literal",
        lang: "Latin → Modern English",
        ...
        tension: "Literal was the most precise word in the language — it meant exactly and only what it said. It is now used to mean the opposite: hyperbolic emphasis. The word for precision became a tool for exaggeration.",
    },
    {
        root: "actually",
        ...
        tension: "Actually once staked a claim to reality — it meant 'in actual fact.' Now it introduces mild disagreement or softens a correction. The word for certainty became a politeness tool.",
    },
    {
        root: "really",
        lang: "Latin → Modern English",
        ...
        tension: "Really compressed reality itself into a filler syllable. It now does so much conversational work — intensifying, questioning, expressing surprise — that its original claim on truth has nearly vanished.",
    },
    {
        root: "dreadful",
        lang: "Old English → Modern English",
        ...
        tension: "Dreadful once described the wrath of God. It now describes a dull lecture or a bad haircut. Terror became a synonym for inconvenience as the emotion of dread lost its catastrophic scale.",
    },
    {
        root: "tremendous",
        lang: "Latin → Modern English",
        ...
        tension: "Tremendous meant 'to be trembled at.' The same path as terrible, awful, dreadful — a word for shaking fear turned into a synonym for 'very good.' English has systematically recycled its terror vocabulary into praise.",
    },
    // ── METAPHOR & TECH DRIFT (continued) ────────────────────────────────────────
    {
        ...
        tension: "Douglas Engelbart named his 1965 invention a 'mouse' because the cord looked like a tail. A word that had meant the same small mammal for a thousand years split into two simultaneous meanings in a single engineering report.",
    },
    {
        root: "spam",
        ...
        tension: "The Monty Python sketch — where every dish is unavoidably SPAM — became the metaphor for unavoidable digital noise. A canned meat brand traveled through a comedy sketch to become the universal word for internet pollution.",
    },
    {
        root: "troll",
        ...
        tension: "The internet troll may come from 'trolling' (fishing by dragging a lure) rather than the Norse monster — but the monster has since infected the metaphor. The digital troll now lives under the bridge of every comment section.",
    },
    // ── EUPHEMISM TREADMILL (continued) ──────────────────────────────────────────
    {
        ...
        tension: "Moron was invented as a precise scientific term in 1910. Within a generation it had leaked into the general vocabulary as an insult. The euphemism treadmill: yesterday's clinical precision is tomorrow's slur.",
    },
    {
        root: "sanitation",
        lang: "Latin → Modern English",
        ...
        tension: "Sanitation began as the language of health — the sanitary reform movement. We borrowed a word for wholeness to describe our waste because health-language made the unpleasant seem respectable. The health word now primarily means 'garbage.'",
    },
    {
        root: "special",
        lang: "Latin → Modern English",
        ...
        tension: "Special was borrowed to soften. By making difference sound like distinction, the word entered the euphemism treadmill: as its coded meaning became widely understood, 'special' acquired a second layer of irony that the original positive meaning now must fight against.",
    },
];
// Provenance annotations
(0, sources_1.applyDatasetProvenance)(exports.MEANING_DRIFT_POOL_2, "meaning_drift_2");
