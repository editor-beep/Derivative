...
exports.NORSE_BORROWED_POOL = exports.NORSE_CONSONANT_POOL = void 0;
...
exports.NORSE_CONSONANT_POOL = [
    {
        ...
        tension: "Skirt and shirt are the same garment word — Norse kept the hard k while Old English softened it to sh. Skull and shell are the same casing, split by language.",
    },
    {
        ...
        tension: "Scatter and shatter are twin destruction words — Norse disperses, Saxon breaks. Scrape and shear are twin removal words — one grinds, one cuts.",
    },
    {
        ...
        tension: "Kirk is what Scots and Northerners still call a church — the hard Norse k never softened. Dike and ditch, egg and edge: each pair shows where the two dialects drew the border.",
    },
];
...
exports.NORSE_BORROWED_POOL = [
    {
        ...
        tension: "The entire English plural pronoun system was replaced by Norse. 'They/them/their' are Scandinavian invaders — Old English said 'hie/hem/here' and Norse made them vanish.",
    },
    {
        ...
        tension: "Every '-by' town (Derby, Whitby) and '-dale' valley (Airedale, Teesdale) is a Viking settlement marker. The landscape of Northern England is written in Old Norse.",
    },
    {
        ...
        tension: "Law, husband, fellow, trust — the Viking contribution to English social life is enormous. 'Husband' means the one bound to the house; 'fellow' means the one who lays down money.",
    },
    {
        ...
        tension: "Norse 'taka' killed Old English 'niman' (to take). 'Die' is Norse — Old English 'starfan' meant any kind of death, not just famine. 'Sky' is physical Norse air; 'heaven' was the spiritual Old English dome.",
    },
    {
        ...
        tension: "Window is 'wind-eye' in Norse — it replaced the Old English 'eye-hole.' Egg replaced 'ey.' Knife replaced 'seax' (which survives only in 'Essex'). The Norse reformed the kitchen and the house.",
    },
];
// Provenance annotations
(0, sources_1.applyDatasetProvenance)(exports.NORSE_CONSONANT_POOL, "norse_consonant");
(0, sources_1.applyDatasetProvenance)(exports.NORSE_BORROWED_POOL, "norse_borrowed");
