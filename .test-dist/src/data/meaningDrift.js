...
exports.MEANING_DRIFT_POOL = void 0;
...
exports.MEANING_DRIFT_POOL = [
    // ── PEJORATION (good/neutral → bad) ─────────────────────────────────────────
    {
        ...
        tension: "Gossip began as a sacred bond — your child's godparent. The spiritual relationship decayed into social noise over four hundred years.",
    },
    {
        root: "crafty",
        lang: "Old English → Modern English",
        ...
        tension: "Skill became suspicious. Crafty once meant what 'skilled' means now — the shift tells us something about how expertise was viewed by those who didn't have it.",
    },
    {
        root: "lewd",
        lang: "Old English → Modern English",
        ...
        tension: "The Church decided that anyone outside the clergy was ignorant; ignorant became low; low became immoral. Lewd is the complete story of clerical contempt for the laity.",
    },
    {
        root: "hussy",
        lang: "Old English → Modern English",
        ...
        tension: "Hussy is housewife with the respectability stripped away — a word for domestic authority dragged through four centuries of class contempt.",
    },
    {
        root: "knave",
        lang: "Old English → Modern English",
        ...
        tension: "Youth was made untrustworthy. Being a boy became being a servant; being a servant became being a scoundrel — a complete slide from innocence to villainy.",
    },
    // ── AMELIORATION (bad/neutral → good) ───────────────────────────────────────
    {
        ...
        tension: "The servant rose to hero status. Knight began as the word for a boy doing chores — the rise of feudalism turned the servant into the symbol of an entire moral code.",
    },
    {
        root: "lord",
        lang: "Old English → Modern English",
        ...
        tension: "Lord began as a bread-keeper. The man who controlled the grain controlled the people — and the word rose with him from kitchen steward to the highest title in the land.",
    },
    {
        root: "lady",
        lang: "Old English → Modern English",
        ...
        tension: "Lady and lord both rose from the bakehouse. She kneaded the bread; he guarded it. The entire feudal hierarchy of medieval England was baked into two words.",
    },
    {
        root: "prestigious",
        ...
        tension: "Prestigious once meant 'full of tricks.' What was a juggler's deception became a social credential — we still call it prestige, but we mean the opposite of what the Romans did.",
    },
    // ── SEMANTIC BLEACHING ───────────────────────────────────────────────────────
    {
        root: "terrible",
        ...
        tension: "Terrible once meant what Tolkien's Balrog was. Two centuries of casual use turned a word for divine terror into a word for a disappointing meal.",
    },
    {
        root: "fantastic",
        ...
        tension: "Fantastic began as 'what the mind invents.' The imagination was suspect in classical thought — 'unreal' became 'eccentric' became 'excellent' as imagination was rehabilitated.",
    },
    {
        root: "incredible",
        lang: "Latin → Modern English",
        ...
        tension: "Incredible means the impossible has happened. We use it for pizza. The word now works as a compliment precisely because its original force — the shock of the unbelievable — has drained away.",
    },
    {
        root: "idiot",
        lang: "Greek → Latin → Modern English",
        ...
        tension: "The Greeks considered anyone who didn't participate in democracy to be an 'idiot.' The word climbed down from political abstention through ignorance to clinical diagnosis to everyday insult.",
    },
    // ── TECH DRIFT ───────────────────────────────────────────────────────────────
    {
        root: "virus",
        ...
        tension: "Virus traveled from Roman poison to invisible biological agent to digital destroyer — the same metaphor of invisible contamination applied at three different scales of reality.",
    },
    {
        root: "cloud",
        lang: "Old English → Modern English",
        ...
        tension: "Cloud started as a rock. Then it floated. Then it became a metaphor for anything that billows and conceals. Now it stores your photographs somewhere no one can clearly point to.",
    },
];
// Provenance annotations
(0, sources_1.applyDatasetProvenance)(exports.MEANING_DRIFT_POOL, "meaning_drift_1");
