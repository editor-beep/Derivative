...
exports.FOLK_ETYMOLOGY_POOL = void 0;
...
exports.FOLK_ETYMOLOGY_POOL = [
    ...
    // A word was misheard at the article boundary: "an ekename" → "a nickname."
    {
        ...
        tension: "The 'n' in 'an' kept jumping ship. 'An ewt' became 'a newt'; 'a napron' became 'an apron.' The article and the noun played tug-of-war with a single consonant for centuries.",
    },
    {
        ...
        tension: "The snake was a 'nadder' until 'an nadder' became 'an adder.' The orange was 'norange' in Old French (from Arabic 'naranj') until speakers heard 'an orange.' The article took the initial consonant as its own.",
    },
    ...
    // Scholars added letters to make vernacular words look more Latin or Greek.
    {
        ...
        tension: "Island gained an 's' to honor Latin 'insula' — but the word is Germanic and has nothing to do with insula. Rhyme gained an 'h' to look like Greek 'rhythmos.' Could gained an 'l' just because would and should had one.",
    },
    {
        ...
        tension: "Comptroller is 'controller' wearing a false Latin degree — the 'comp' was inserted to suggest a link to French 'compte' (account) that was never there. Fault gained an 'l' to resemble Latin 'fallere'; the French had already dropped it.",
    },
    {
        ...
        tension: "Ptarmigan is a Gaelic word given a Greek-style silent 'pt' to make it look scholarly. Abominable was spelled 'abhominable' for centuries because scholars thought it meant 'away from man' (ab-homine) — it doesn't.",
    },
    // ── TRUE FOLK RESHAPING ───────────────────────────────────────────────────
    // A foreign word was so unfamiliar that speakers reshaped it to match known words.
    {
        ...
        tension: "Cockroach has nothing to do with cocks or roaches — it's Spanish 'cucaracha' forced into familiar English shapes. Bridegroom's 'groom' replaced 'guma' (man) because 'guma' died out. Woodchuck is pure phonetic mimicry of an Algonquian word.",
    },
    {
        ...
        tension: "Penthouse was never a top-floor luxury apartment — it was a lean-to shed that 'hangs' against a wall. Curfew meant 'cover the fire' at bedtime; we forgot the fire and only remembered the time. Belfry only got its bells because we started putting bells in siege towers.",
    },
    {
        ...
        tension: "The ten-gallon hat holds no gallons — 'tan galán' meant 'so gallant' in Spanish. Buckaroo is 'vaquero' chewed up and re-spat in a Texas accent. Lariat is 'la reata' with the article welded onto the noun.",
    },
    {
        ...
        tension: "Jerusalem artichoke has nothing to do with Jerusalem — 'girasole' (sunflower in Italian) sounded like 'Jerusalem' to English ears. Humble pie was 'umble' pie (made from deer innards); the humiliation was added by folk etymology. Coleslaw was always cabbage.",
    },
    {
        ...
        tension: "Pea, cherry, and sherry all ended in a sound that resembled a plural '-s,' so speakers assumed they were plural and invented new singulars. Pease porridge is still correct — a pea is a grammatical accident.",
    },
];
// Provenance annotations
(0, sources_1.applyDatasetProvenance)(exports.FOLK_ETYMOLOGY_POOL, "folk_etymology");
