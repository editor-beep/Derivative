...
exports.FRENCH_FALSE_FRIENDS_POOL = exports.FRENCH_DOUBLETS_POOL = exports.FRENCH_VISUAL_FRAUD_POOL = void 0;
...
exports.FRENCH_VISUAL_FRAUD_POOL = [
    {
        ...
        groups: [
            {
                ...
                displayLabel: "Descendant tag: [LATIN-COSPLAY_B]",
                solutionLabel: "Modern spelling (silent b inserted)",
            ...
            },
            {
                ...
                displayLabel: "Descendant tag: [FRENCH-BASELINE_BØ]",
                solutionLabel: "French origin (no silent b)",
                accepts: ["dette", "doute", "sotil"],
                related: ["dette", "dubitum"],
            },
        ],
        pool: ["debt", "doubt", "subtle", "dette", "doute", "sotil"],
        tension: "The 'b' in debt, doubt, and subtle was never pronounced — it was grafted onto French words to make them look like their Latin grandparents.",
    },
    {
        ...
        groups: [
            {
                ...
                displayLabel: "Descendant tag: [SCRIBE-PATCH_C]",
                solutionLabel: "Modern spelling (silent c inserted)",
            ...
            },
            {
                ...
                displayLabel: "Descendant tag: [OLD-FRENCH_STREAM_CØ]",
                solutionLabel: "French origin (no silent c)",
                accepts: ["enditer", "verdit", "cisoires", "vitaille"],
                related: ["musculus"],
            },
        ],
        pool: ["indict", "verdict", "scissors", "victuals", "enditer", "verdit", "cisoires", "vitaille"],
        tension: "We say 'vittles' but write 'victuals'; we say 'indite' but write 'indict' — Latin prestige dressed up French words.",
    },
    {
        ...
        groups: [
            {
                ...
                displayLabel: "Descendant tag: [RESTORATION-PRINT]",
                solutionLabel: "Restored Latin spelling",
            ...
            },
            {
                ...
                displayLabel: "Descendant tag: [PRE-REPAIR_FRENCH]",
                solutionLabel: "French form (before Latin repair)",
        ...
        tension: "16th-century scribes restored Latin clusters that French had long since smoothed away — the spelling became a fossil museum.",
    },
    {
        ...
        groups: [
            {
                ...
                displayLabel: "Descendant tag: [PHANTOM-LETTER_BRANCH]",
                solutionLabel: "Modern form (hallucinated letter)",
            ...
            },
            {
                ...
                displayLabel: "Descendant tag: [SOURCE-FORM_BRANCH]",
                solutionLabel: "Origin form (no hallucinated letter)",
        ...
        tension: "An 'h' added for Greek ancestry, an 's' from a misread island, a 'p' to dress up a bill — each silent letter is a scribal decision frozen in place.",
    },
];
...
exports.FRENCH_DOUBLETS_POOL = [
    {
        ...
        tension: "Royal and regal share the same Latin root — one drifted through French courts as a feeling, the other stayed in Latin as a statute.",
    },
    {
        ...
        tension: "Chief leads the army in French; captain leads it in Latin. Chef commands the kitchen. All three heads share the same Latin skull.",
    },
    {
        root: "caballarius",
        ...
        tension: "Cavalry is what horses do in battle; chivalry is the moral code that justified doing it — same root, one pragmatic, one idealized.",
    },
    {
        ...
        tension: "Hotel and hospital are the same building — one for the rich who travel, one for the sick who can't. Channel and canal are the same cut through earth.",
    },
    {
        ...
        tension: "Poor wandered through French streets; pauper stayed in Latin books. Warranty and guarantee are the same Germanic pledge split by dialect — one Norman, one Central French.",
    },
    {
        ...
        tension: "The Normans didn't raise the animals — they ate them. English serfs kept the Saxon names for living beasts; their lords imported French names for what arrived at the table.",
    },
];
...
exports.FRENCH_FALSE_FRIENDS_POOL = [
    {
        ...
        groups: [
            {
                ...
                accepts: ["actual", "eventually", "attend"],
                related: ["factual", "finally", "show up"],
            },
            {
                id: "french",
                label: "French meaning (false cognate)",
                accepts: ["actuel", "éventuellement", "attendre"],
                related: ["current", "maybe", "stay behind"],
            },
        ],
        pool: ["actual", "eventually", "attend", "actuel", "éventuellement", "attendre"],
        tension: "Actual means 'true' in English but 'current' in French; eventually means 'certainly later' in English but 'possibly' in French — certainty vs. chance, hiding in the same word.",
    },
    {
        ...
        groups: [
            {
                id: "english",
                label: "English meaning",
                accepts: ["sympathetic", "deception"],
                related: ["sensible", "reasonable", "caring", "fraud"],
            },
            {
                id: "french",
                label: "French meaning (false cognate)",
                accepts: ["sympathique", "déception"],
                related: ["sensible", "emotional", "pleasant", "letdown"],
            },
        ],
        pool: ["sympathetic", "deception", "sympathique", "déception"],
        tension: "English sensible went to the head; French sensible stayed in the heart. Deception in English is a lie you tell; in French it's the feeling when the lie is discovered.",
    },
    {
        ...
        groups: [
            {
                id: "english",
                label: "English meaning",
                accepts: ["library", "fabric"],
                related: ["coin", "bookshelf", "textile", "currency"],
            },
            {
                id: "french",
                label: "French meaning (false cognate)",
                accepts: ["librairie", "fabrique"],
                related: ["coin", "bookstore", "plant", "corner of a room"],
            },
        ],
        pool: ["library", "fabric", "librairie", "fabrique"],
        tension: "We stole the library building but left the French their bookshop. Fabric became the product, not the factory. Coin came from the corner of the mint where stamps were cut.",
    },
    {
        ...
        groups: [
            {
                ...
                label: "English meaning",
                accepts: ["hazard"],
                related: ["pain", "peril", "suffering"],
            },
            {
                id: "french",
                label: "French / Arabic origin meaning",
                accepts: ["hasard"],
                related: ["pain", "dice game", "daily bread"],
            },
        ],
        pool: ["hazard", "hasard"],
        tension: "Hazard came from Arabic dice — pure chance — and English turned luck into danger. Pain is the most basic collision: the French staff of life became the English word for suffering.",
    },
];
// Provenance annotations
(0, sources_1.applyDatasetProvenance)(exports.FRENCH_VISUAL_FRAUD_POOL, "french_visual_fraud");
(0, sources_1.applyDatasetProvenance)(exports.FRENCH_DOUBLETS_POOL, "french_doublets");
(0, sources_1.applyDatasetProvenance)(exports.FRENCH_FALSE_FRIENDS_POOL, "french_false_friends");
