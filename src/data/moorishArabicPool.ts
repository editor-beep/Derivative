...
export const MOORISH_ARABIC_POOL: SortPoolEntry[] = [
  // --- PUZZLE 1 (Tier 1): Science, math, and the sky ---
  {
    ...
    revealBody:
      "The 12th-century translation movement — when European scholars traveled to Toledo, Córdoba, and Salerno to translate Arabic scientific texts into Latin — transferred the entire intellectual infrastructure of Islamic scholarship into European universities. Al-Khwarizmi's algebra and his number system. Ibn al-Haytham's optics. Al-Battani's astronomy. The words survived the translation intact, which is why the language of European mathematics is still Arabic. Alkali launched the European tradition of alchemy (itself from Arabic al-kimiya) and eventually chemistry: the Moors had been distilling, refining, and experimenting with substances centuries before Paracelsus claimed the field as European. Zenith is still the technical astronomical term for the point directly overhead — because the Moorish astronomers who defined it named it first, and their nomenclature was adopted wholesale.",
  },
