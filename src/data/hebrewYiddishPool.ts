...
export const HEBREW_YIDDISH_POOL: SortPoolEntry[] = [
  // --- PUZZLE 1: Yiddish survival vocabulary by semantic domain ---
  {
    ...
    tension:
      "Yiddish flooded American English through the labor and entertainment industries — a language the immigrant working class carried across borders and into common speech",
    questionPrompt:
      "These Yiddish words all entered English through the immigrant experience. Classify each by what it was used to do.",
    revealHeadline: "Yiddish didn't enter English through scholarship. It came through street commerce, comedy, and survival.",
    revealBody:
      "The words cluster by function: some arm you with nerve (chutzpah, bupkis, gonif) — the right to name the absurdity of the system you're trapped in. Others carry the weight of the working day (schlep, kvetch, shvitz). The third group holds the social glue of a community rebuilding itself in every city it was pushed to. Yiddish gave English not just vocabulary but a philosophical stance — that you call the thing what it is, even if it gets you in trouble.",
  },
