export const GRIMM_POOL = [
  {
    root: "p→f shift",
    lang: "Proto-Indo-European → Germanic",
    meaning: "Grimm's Law",
    pairs: [
    ...
    tension:
      "Germanic languages systematically shifted voiceless stops — Latin p became English f",
  },
  {
    root: "t→th shift",
    lang: "Proto-Indo-European → Germanic",
    ...
    tension:
      "Latin 't' became 'th' in all Germanic languages — a perfectly predictable sound law",
  },
  {
    root: "k→h shift",
    lang: "Proto-Indo-European → Germanic",
    ...
    tension:
      "Latin initial 'c' (k-sound) became 'h' in English — revealing deep shared ancestry",
  },
  {
    root: "d→t shift",
    lang: "Proto-Indo-European → Germanic",
    ...
    tension:
      "Proto-Indo-European voiced stops became voiceless in Germanic — d became t",
  },
];
