...
export const CAPITONYM_POOL: SortPoolEntry[] = [
  // --- PUZZLE 1: Nations in Disguise ---
  {
    ...
    meaning:
      "words whose capital form names an empire, a god, a church, or a month — and whose lowercase form names the ordinary thing underneath",
    groups: [
      {
        id: "nations_as_objects",
        displayLabel: "nations reduced to objects",
        solutionLabel:
          "Country names absorbed into the commodity or craft they gave the world",
        hint: "Each of these words is a nation, lowercased. The nation's most famous export or craft became the common noun.",
        hintLevel2:
          "Poland gave its name to a shine. Turkey gave its name to a bird — or the bird gave it to the country; historians argue. China gave its name to ceramic ware. Morocco gave its name to fine goatskin leather.",
      ...
      },
      {
        ...
        solutionLabel:
          "Month names whose lowercase forms are active verbs or dignified adjectives — the calendar seized ordinary language",
        hint: "Each of these is a month of the year. Lowercase, it becomes something you do or something you are.",
        hintLevel2:
          "One means to walk in military step. One means to be permitted or to be possible. One means majestic, dignified — the quality an emperor wanted named after himself.",
      ...
      },
      {
        ...
        solutionLabel:
          "Political and religious proper nouns whose lowercase forms became general qualities — the institution colonised the adjective",
        ...
        hintLevel2:
          "One means generous and open-minded. One means cautious and preserving. One means universal and wide-ranging — the Church wanted the whole world in that word.",
      ...
      },
      {
        ...
        solutionLabel:
          "Names of gods, poets, and people whose lowercase forms became common objects or achievements",
        ...
        hintLevel2:
          "One names the winged messenger god — and a liquid metal. One names the first great Western poet — and a baseball home run. One is someone's first name — and an invoice, or a bird's beak.",
  ...
  // --- PUZZLE 2: The Colonised Calendar & the Church's Grammar ---
  {
    ...
    meaning:
      "capitonyms sorted by the kind of authority that colonised them: a period of time, a place that became its own export, or a religious term that leaked into secular language",
    groups: [
      {
        id: "time_as_authority",
        displayLabel: "periods of time the powerful named and owned",
        solutionLabel:
          "Words whose capital form names an institutionally controlled period of time",
        ...
        hintLevel2:
          "One is the month that names both a Roman emperor and the quality of majesty. One is the 40-day Christian fast before Easter — whose name overlaps with the past tense of 'to lend.' One is a legislative assembly whose most famous session was convened at a German city famous for worms.",
      ...
      },
      {
        ...
        solutionLabel:
          "Country or region names that became the common noun for the craft or commodity they exported",
        ...
        hintLevel2:
          "One is a lacquering technique named for the island nation that perfected it. One is a fine North African leather. One is a West African coastal region that gave its name to a gold coin worth 21 shillings. One is a French wine region whose sparkling wine became the Empire's celebration drink.",
      ...
      },
      {
        ...
        solutionLabel:
          "Names of religious institutions or figures whose lowercase form became a general secular quality",
        ...
        hintLevel2:
          "One relates to Moses and Jewish law — and names an art form made of coloured tiles. One names the Religious Society of Friends — and the person who trembles. One was the Church's claim to universality — and the secular word for 'all-encompassing.'",
  ...
  // --- PUZZLE 3: Match — "Strip the Capital" ---
  {
    ...
    meaning:
      "match each lowercased capitonym to the hidden Imperial identity its capital form names",
    groups: [],
    pool: [
      "polish",
      "guinea",
...
applyDatasetProvenance(CAPITONYM_POOL, "capitonym");
